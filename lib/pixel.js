...
function PixelJS() {
    ...
    this._events = { keydown: undefined, keyup: undefined };
    ...
    document.onkeydown = function (e) {
        ...
        var keyCode = e.keyCode, callback = self._events.keydown;
    ...
    document.onkeyup = function (e) {
        ...
        var keyCode = e.keyCode, callback = self._events.keyup;
        if (callback !== undefined) {
            callback(keyCode);
        }
    };
...
PixelJS.prototype.createSprite = function () {
    return new this.Sprite(this);
};

PixelJS.prototype.createAnimatedSprite = function () {
    return new this.AnimatedSprite(this);
};
