...
PixelJS.prototype.Sprite.prototype.draw = function (args) {
    if (this._assetLoaded) {
        this.engine.ctx.putImageData(this._assetData, this.pos.x, this.pos.y);
    }
};
    
PixelJS.prototype.Sprite.prototype.moveLeft = function () {
    this.pos.x -= this.speed * this.engine.timeSinceLastUpdate;
};
...
PixelJS.prototype.Sprite.prototype.moveDown = function () {
    this.pos.y += this.speed * this.engine.timeSinceLastUpdate;
};
