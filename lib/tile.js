...
PixelJS.prototype.Tile = function (layer) {
    "use strict";
...
PixelJS.prototype.Tile.prototype.load = function (info, callback) {
    ...
    this._assetImage.onload = function () {
        self._pattern = self.layer._ctx.createPattern(self._assetImage, "repeat");
        ...
        self._img.src = self._buffer.toDataURL();
    };
};

PixelJS.prototype.Tile.prototype.update = function (elapsedTime, dt) {
};
    
PixelJS.prototype.Tile.prototype.draw = function (args) {
    if (this._assetLoaded) {
        this.layer.drawImage(this._img, this.pos.x, this.pos.y);
    }
};