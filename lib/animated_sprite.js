...
PixelJS.prototype.AnimatedSprite.prototype.draw = function (args) {
    ...
    if (this._loaded) {
        ...
        if (this.hasTransparentBackground) {
            this.engine.drawTransparentImage(this.spriteSheet._frameData[this.row][this._currentFrame], this.pos.x, this.pos.y);
        }
        else {
            this.engine.drawImage(this.spriteSheet._frameData[this.row][this._currentFrame], this.pos.x, this.pos.y);
        }
    }
};